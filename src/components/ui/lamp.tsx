  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
        ...
        <div className="absolute top-1/2 h-32 w-full translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
        <div className="absolute top-1/2 z-50 h-36 w-full bg-transparent opacity-10 backdrop-blur-md "></div>
        <div className="absolute inset-auto z-50 h-40 w-[28rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl "></div>
        <motion.div
          initial={{ width: "8rem" }}
